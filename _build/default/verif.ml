...
let verif_prog prog =
  ...
  (* Vérifier que toutes les fonctions dans la liste prog sont bien typées *)
  ...
  (*List.exist: verifie si au moins une fonction dans la liste prog 
  est une fonction main sans parametres *) 
